...
\caption{Sample results from a baseline segmentation approach based on similariity
...
\caption{Sample results from our Markov random walk based segmentation approach.}
\figlab{markov_best}
\end{figure}
