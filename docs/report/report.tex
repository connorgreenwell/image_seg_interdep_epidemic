...
convolutional neural networks to segment an image into its constituent object
parts.
...
joined with some number of interdependence links between nodes in each graph.
...
\begin{figure}[t]
  ...
  of high quality segmentations. In this case, this indicates that our method is
